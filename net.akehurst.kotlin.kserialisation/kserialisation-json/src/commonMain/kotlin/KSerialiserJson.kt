    ...
    fun toJson(root: Any, data: Any): String {
        ...
        val walker = kompositeWalker<List<String>, JsonValue>(registry) {
            ...
            collElementEnd { key, info, element ->
                ...
                WalkInfo(path, elements)
            }
            collEnd { key, info, type, coll ->
