...
mavenPublishing {
    ...
    pom {
        name.set("net.akehurst.kotlin.kserialisation")
        description.set("Multiplatform serialisation library")
        url.set("https://github.com/dhakehurst/net.akehurst.kotlin.kserialisation")
